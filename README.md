# Jackpotty Slots — Rainbet wager leaderboard

Live at **https://jackpottyslots.com/**

A one-page static site showing a $250 monthly wager leaderboard for Rainbet
affiliate code **POTTY**. Generated from the Forge Partners leaderboard
...
| Setting | Value |
| --- | --- |
| Affiliate code | `POTTY` |
| Referral link | https://rainbet.com?r=potty |
...
5. **Point the domain** at Netlify and wait for the TLS certificate. A new
   ...
   certificate is actually issued for `jackpottyslots.com` before telling anyone the
   site is live.
...
`creators/jackpottyslots.json` in the template repo. Edit that, re-run
`node new-creator.mjs jackpottyslots`, and copy the regenerated files over. The cycle
